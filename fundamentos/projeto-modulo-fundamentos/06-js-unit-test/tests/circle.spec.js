...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    it('Verifica se a função circle retorna3 propriedades.', () => {
    ...
    it('Verifica se a função circle retorna undefined, caso não haja parâmetro.', () => {
    ...
    it('Verifica se a função circle retorna uma chave com valor igual a circunferência correta para um círculo de raio 2..', () => {
    ...
    it('Verifica se a função circle retorna uma chave com valor igual a area correta para um círculo de raio 3.', () => {
