...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Verifica se a função retorna o obejeto correto para o parâmetro `Melissandre`', () => {
  ...
  it('Verifica se os parâmetro não são Case Sensitive', () => {
    expect(getCharacter('ArYa')).not.toBeUndefined();
  });
  // Teste se ao passar um nome que não está na tabela, a função retorna undefined.
  it('Verifica se ao passar um nome que não está na tabela, a funçao retorna `undefined`', () => {
